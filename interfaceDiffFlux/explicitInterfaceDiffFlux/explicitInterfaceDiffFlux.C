...
// Foam::tmp<Foam::volVectorField> Foam::explicitInterfaceDiffFlux::intGrad
// (
//     const boolList& markedCells,
//     const volVectorField& normal,
//     const volVectorField& centre,
...
//             ),
//             mesh_,
//             dimensionedVector("init",phi.dimensions()/dimLength,vector::zero),
//             calculatedFvPatchVectorField::typeName
//         )
//     );

//     volVectorField& intGrad = intGradPtr.ref();
